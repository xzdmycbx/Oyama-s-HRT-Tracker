...
if (import.meta.env.DEV) {
  ...
  console.log('[Config] Source:',
    runtimeEnv.__ENV__?.VITE_TURNSTILE_SITE_KEY ? 'window.__ENV__' :
    runtimeEnv.VITE_TURNSTILE_SITE_KEY ? 'globalThis' :
    import.meta.env.VITE_TURNSTILE_SITE_KEY ? 'import.meta.env' :
    'Fallback hardcoded');
}
